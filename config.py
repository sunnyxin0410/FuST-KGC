...
parser.add_argument('--pretrained-model', default='distilbert', type=str, metavar='N',
...
parser.add_argument('--valid-path', default='data/WN18RR/test.txt.json', type=str, metavar='N',
                    help='path to valid data')
parser.add_argument('--model-dir', default='./checkpoints', type=str, metavar='N',
...
parser.add_argument('--max-num-tokens', default=200, type=int,
...
parser.add_argument('--eval-model-path', default='checkpoints/model_best.mdl', type=str, metavar='N',
